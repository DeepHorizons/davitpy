...
Cf2py intent(in) :: JF,JMAG,ALATI,ALONGI,IYYYY,MMDD,DHOUR
Cf2py intent(in) :: HEIBEG,HEIEND,HEISTP
Cf2py intent(in,out) OARR
Cf2py intent(out) OUTF
...
Cf2py intent(in) :: height,h_tec_max,ivar,vbeg,vend,vstp
