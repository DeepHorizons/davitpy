      SUBROUTINE IGRF11(ITYPE,DATE,ALT,IFL,
...
!      END IF
      ...
      NCOUNT = 0
!      WRITE(6,*) 'Input: ',ITYPE,IFL,DATE,ALT,
!     1      XLTI,XLTF,XLTD,XLNI,XLNF,XLND
C
...
!      IF (ITYPE.LT.1.OR.ITYPE.GT.2) GO TO 10
      IF (ITYPE.LT.1.OR.ITYPE.GT.2) WRITE(6,*) 'Incorrect option ITYPE'  ! Edit SdL
...
c
  ...
  961 format (/' This subroutine will not work with a date of',
     1        f20.3,'.  Date must be in the range 1900.0.ge.date',
